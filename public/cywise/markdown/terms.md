...
Les sauvegardes sont hébergées par :
...
**La Société :** désigne la société ComputableFacts.
...
Internet, [cywise.io](https://app.cywise.io), La Société met à disposition des personnes physiques en faisant la
...
- Notifier l'Utilisateur si une information sensible ou une vulnérabilité est découverte par La Société.

Cette liste est non limitative, de nouveaux services pouvant être ajoutés gracieusement ou non par La Société à
l'avenir.

Le service est réputé être mis à la disposition du Client « en l'état » sans faire l'objet de mesures d'adaptations
spécifiques. Il s'apparente à un progiciel standard qui ne saurait répondre à tous les besoins spécifiques du Client. Il
appartient donc au Client de vérifier l'adéquation du logiciel proposé par La Société avec ses besoins et de prendre
toutes les précautions nécessaires.

L'Utilisateur est seule responsable de l'utilisation du service et en comprend l'utilité autant que les limites.

## <a name="article-3">Article 3 : Champ d'application</a>

L'utilisation des Services proposés par La Société est réservée aux particuliers ou entreprises pour leurs besoins
propres. Si un professionnel souhaite utiliser les services de La Société pour le revendre à ses clients ou
...
Pour bénéficier des services proposés par La Société, le client doit créer un compte utilisateur sur le Site, soit
...
les prestations attendues ne pourront être pleinement exécutées par La Société, sans que La Société soit en mesure
...
de ses identifiant et mot de passe, la responsabilité de La Société ne saurait être engagée.
...
Les Données Personnelles recueillies par La Société lors de la création du compte utilisateur et lors de l'utilisation
de l'Espace Sécurisé ont pour but :
...
La Société s'engage à ne pas fournir les données personnelles de ses Utilisateurs à des tiers, gracieusement ou contre
rémunération sauf aux tiers désignés par l'utilisateur lui-même dans le cadre du service, ou aux autorités légales par
...
La Société annule systématiquement la commande d'abonnement.

La Société utilise le système de paiement Stripe. La Société n'a pas accès aux informations relatives aux moyens de
paiement de l'utilisateur et ne reçoit qu'un numéro de transaction assorti d'un code de succès ou d'échec de la
transaction, pour cette raison, La Société décline toute responsabilité dans ce processus.

La Société se réserve le droit de modifier ses prix à tout moment, mais s'engage à appliquer pendant 1 an les tarifs en
vigueur lors de la confirmation de la Commande pour tout Client ayant commandé un abonnement.
...
du délai, par email à support@cywise.io.
...
La Société ne saurait être engagée pour tout dommage subi par le Client ou par un tiers résultant directement ou
...
La responsabilité de La Société ne pourra être engagée pour tout dommage subi par le Client ou par un tiers qui
résulterait du fait d'un tiers.

La Société ne saurait être tenu responsable en cas d'incompatibilité du système informatique du Client avec le
...
Les registres informatisés, conservés dans les systèmes informatiques de La Société et/ou de ses prestataires dans
...
La Société archive les factures sur un support fiable et durable constituant une copie fidèle, conformément aux
...
pratiques et engagements du service La Société en matière de collecte, traitement, protection, rectification et
...
Les traitements des données explicites sont réalisés exclusivement par La Société.

Les données collectées par La Société ne sont ni vendues, ni prêtées, ni louées à des tiers, en aucune manière que ce
soit.
...
que sur réquisition judiciaire. Cette période est automatiquement étendue autant que nécessaire dès lors que La Société
reçoit une demande judiciaire ou une notification de plainte.
...
privacy@cywise.com, avant effacement définitif.
...
- Les Utilisateurs peuvent demander un **accès** (une copie) des données personnelles en notre possession. Nous attirons
  ...
  ceci pour des raisons de sécurité liées au fondement même du service.
...
La Société s'appuie sur les outils suivants :
...
- [DeepInfra](https://deepinfra.com/). C'est la plateforme que nous utilisons pour accéder à des ressources GPU lorsque
  nécessaire. Pour plus d'informations, veuillez consulter la Politique de Confidentialité de DeepInfra.

Cookies déposés par La Société directement :

- XSRF-TOKEN, identificateur unique de session, permet à La Société de stocker les informations relatives à votre
  session.
...
et/ou par simple demande par courrier électronique à l'adresse privacy@cywise.io ou par courrier postal à
