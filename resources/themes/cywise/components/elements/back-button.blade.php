<div {{ $attributes->twMerge('lg:px-5 mx-auto w-full lg:px-0') }}>
    <a href="{{ $href ?? '' }}" class="inline-flex items-center px-2.5 py-1.5 mb-3 lg:mb-1 md:mb-6 text-xs font-semibold rounded-full border cursor-pointer text-blue-900 bg-blue-100 border-blue-200 group">
