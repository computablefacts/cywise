<div class="fixed inset-0 z-40 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
    <div id="toast" x-data x-cloak
        ...
        class="w-full max-w-sm bg-white border border-zinc-200 rounded-lg shadow-lg cursor-pointer pointer-events-auto hover:-translate-1">
            ...
            <div class="px-4 py-5">
                <div class="flex items-center">
                    ...
                    <div class="flex self-start flex-shrink-0 ml-4">
                        <button @click="$store.toast.close()" class="inline-flex -mt-1 text-zinc-400 transition duration-150 ease-in-out rounded-full focus:outline-hidden focus:text-zinc-500">
