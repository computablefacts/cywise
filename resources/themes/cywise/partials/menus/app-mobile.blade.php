        ...
        <div class="bg-white rounded-lg divide-y-2 shadow-xs divide-zinc-50">
            <div class="px-8 pt-6 pb-8 space-y-6">
                <div class="flex justify-between items-center mt-1">
                    ...
                    <div class="-mr-2">
                        <button @click="mobileMenuOpen = false" type="button" class="inline-flex justify-center items-center p-2 rounded-md transition duration-150 ease-in-out text-zinc-400 hover:text-zinc-500 hover:bg-zinc-100 focus:outline-hidden focus:bg-zinc-100 focus:text-zinc-500">
                ...
                <div>
                    <nav class="grid row-gap-8">
                        <a href="{{ route('wave.dashboard') }}" wire:navigate class="flex items-center p-3 -m-3 space-x-3 rounded-md transition duration-150 ease-in-out hover:bg-zinc-50">
                        ...
                        <a href="{{ route('blog') }}" wire:navigate class="flex items-center p-3 -m-3 space-x-3 rounded-md transition duration-150 ease-in-out hover:bg-zinc-50">
