...
-->
        <div class="px-1 py-1">
            <div class="flex gap-x-4 items-center my-3 text-xs">
                ...
                <a href="{{ $post->linkCategory() }}" wire:navigate class="relative z-10 px-3 py-1.5 font-medium text-zinc-600 bg-zinc-50 rounded-full hover:bg-zinc-100">{{ $post->category->name }}</a>
              </div>
