...
<span class="mono">CAS D’USAGE / VULNÉRABILITÉS</span><h1>TROUVEZ CE QUI PEUT CÉDER.</h1><p>Détectez les faiblesses et transformez-les en liste de correction priorisée.</p>
...
<span class="mono">01 / FONCTIONNALITÉ</span><h3>ANALYSE DE L’EXPOSITION</h3><p>Analysez les systèmes exposés sur Internet.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card">
<span class="mono">02 / FONCTIONNALITÉ</span><h3>IDENTIFICATION DES FAIBLESSES</h3><p>Détectez les composants et configurations vulnérables connus.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card blue-card">
<span class="mono">03 / FONCTIONNALITÉ</span><h3>PRIORISATION</h3><p>Distinguez les urgences des constats à faible impact.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card pink-card">
<span class="mono">04 / FONCTIONNALITÉ</span><h3>EXPLICATION DU RISQUE</h3><p>Comprenez pourquoi chaque problème compte.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card">
<span class="mono">05 / FONCTIONNALITÉ</span><h3>ATTRIBUTION DES ACTIONS</h3><p>Attribuez la bonne correction au bon responsable.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card dark-card">
<span class="mono">06 / FONCTIONNALITÉ</span><h3>SUIVI DE LA RÉSOLUTION</h3><p>Confirmez les progrès dans le temps.</p></article></div></div></div></section>
