...
<span class="mono">POUR QUI / STARTUPS</span><h1>AVANCEZ VITE SANS NÉGLIGER LA SÉCURITÉ.</h1><p>Construisez vos bases de sécurité pendant la croissance du produit et de l’équipe.</p>
...
<span class="mono">01 / FONCTIONNALITÉ</span><h3>MISE EN PLACE RAPIDE</h3><p>Commencez la surveillance sans projet lourd.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card">
<span class="mono">02 / FONCTIONNALITÉ</span><h3>EXPOSITION EXTERNE</h3><p>Suivez les nouveaux actifs publics pendant la croissance du produit.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card blue-card">
<span class="mono">03 / FONCTIONNALITÉ</span><h3>RISQUE IDENTIFIANTS</h3><p>Détectez les comptes de startup compromis.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card pink-card">
<span class="mono">04 / FONCTIONNALITÉ</span><h3>ACCOMPAGNEMENT DES POLITIQUES</h3><p>Créez des politiques de sécurité de base.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card">
<span class="mono">05 / FONCTIONNALITÉ</span><h3>PRÉPARATION AUX AUDITS</h3><p>Préparez des preuves pour les clients et partenaires.</p></article></div><div class="col-md-6 col-xl-4"><article class="solution-card dark-card">
<span class="mono">06 / FONCTIONNALITÉ</span><h3>ACCOMPAGNE LA CROISSANCE</h3><p>Conservez le même flux lorsque l’entreprise grandit.</p></article></div></div></div></section>
