...
use App\Http\Controllers\Iframes\IoCsController;
...
render(function (Request $request) {
  return app(IoCsController::class)($request);
});
?>
      ...
      <div class="col">
        <div class="card">
          <div class="card-body p-3">
            <form method="get" action="{{ route('ioc') }}" class="row g-2 align-items-end">
              <div class="col-sm-8">
              ...
              <div class="col-sm-2">
                <label class="form-label d-block">&nbsp;</label>
                <a href="{{ route('ioc') }}" class="btn btn-secondary w-100">
                  {{ __('Reset') }}
                </a>
              </div>
              @if(request('level'))
