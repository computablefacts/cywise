      ...
      <div class="card-body">
        ...
        <div class="card mb-3" style="background-color:#fff3cd;">
          <div class="card-body p-2">
            <div class="row">
              <div class="col">
                {!! __('Rules are defined using the Osquery SQL-based query language. For detailed syntax, available
                tables, and examples, refer to the <a href="https://osquery.io/schema/" target="_blank">official Osquery
