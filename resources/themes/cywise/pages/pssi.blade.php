          ...
          <div class="max-w-xl text-base/7 text-gray-600 lg:col-span-7">
            ...
            <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
              <li class="flex gap-x-3">
                ...
                <span>
                  Coller aux technologies employées.
                </span>
              </li>
              <li class="flex gap-x-3">
                <svg class="mt-1 size-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor"
                ...
                <span>
                  Être en corrélation avec le savoir-faire du Responsable de la Sécurité des Systèmes d'Information (RSSI).
                </span>
              </li>
              <li class="flex gap-x-3">
                <svg class="mt-1 size-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor"
                ...
                <span>
                  Améliorer les processus pour mieux encadrer les pratiques.
                </span>
              </li>
            </ul>
            <p class="mt-8">
    ...
    <div class="bg-white">
      <div class="mx-auto max-w-7xl px-6 py-12 sm:py-16 lg:flex lg:items-center lg:justify-between lg:px-8">
        <h2 class="max-w-2xl text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
          {!! __('Vous souhaitez rédiger votre propre PSSI?') !!}
        </h2>
